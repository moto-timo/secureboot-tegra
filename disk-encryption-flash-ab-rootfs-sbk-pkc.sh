...
cd `dirname $0`
cd Linux_for_Tegra
sudo ROOTFS_ENC=1 ./flash.sh -c ./bootloader/t186ref/cfg/flash_l4t_t186_enc_rootfs_ab.xml -i ../ekb.key -u ../rsa_priv.pem -v ../sbk_hex_file jetson-agx-xavier-devkit mmcblk0p1
