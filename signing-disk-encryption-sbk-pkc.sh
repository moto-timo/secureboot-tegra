...
cd Linux_for_Tegra
sudo ROOTFS_ENC=1 ./flash.sh --no-flash -i ../ekb.key -u ../rsa_priv.pem -v ../sbk_hex_file --user_key ../user_key_for_flash_hex_file jetson-agx-xavier-devkit mmcblk0p1
...
# oncce the kek2 has been burned, it appears you must generate your own eks.img
# with that as a forcing function, it is also a good time to use the user_key
